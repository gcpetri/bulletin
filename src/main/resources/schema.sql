...
(
    USER_ID BIGSERIAL REFERENCES USERS(USER_ID) ON UPDATE CASCADE,
    SUBMISSION_ID BIGSERIAL REFERENCES SUBMISSIONS(SUBMISSION_ID) ON UPDATE CASCADE,
...
(
    QUESTION_ID BIGSERIAL REFERENCES QUESTIONS(QUESTION_ID) ON UPDATE CASCADE,
    SUBMISSION_ID BIGSERIAL REFERENCES SUBMISSIONS(SUBMISSION_ID) ON UPDATE CASCADE,
